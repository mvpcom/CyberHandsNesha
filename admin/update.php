				...
				<div class="row">
					<form role="form" method="post" name="session_registration_form" action="<?php echo esc_url($_SERVER['PHP_SELF']); ?>">
						<div class="col-lg-6 col-sm-6 col-sm-push-1 col-lg-push-1 ">
							<div class="well well-sm"><strong>به روز رسانی اطلاعات نشست / جلسه</strong></div>
							...
							<div class="form-group">
								<div class="input-group">
									...
									<input type="button" class="btn btn-info pull-right"
										   value="بازیابی اطلاعات" 
										   onclick="return InformationSelectSession(this.form,
											   this.form.session);" /> 											   
							   	</div>
							</div>
							<div id="UpdateFormSession">  
								<div class="form-group">
							...
							<input type="button" class="btn btn-info pull-right"
							   value="ثبت اطلاعات" 
							   onclick="return regformUPDATESession(this.form,
					...
					<form role="form" method="post" name="mentor_registration_form" action="<?php echo esc_url($_SERVER['PHP_SELF']); ?>">
						<div class="col-lg-6 col-sm-6 col-sm-push-1 col-lg-push-1 ">
							<div class="well well-sm"><strong>به روز رسانی اطلاعات مربی</strong></div>
							<div class="form-group">
							...
							<div class="form-group">
								<div class="input-group">
									...
									<input type="button" class="btn btn-info pull-right"
										   value="بازیابی اطلاعات" 
										   onclick="InformationSelectMentor();" /> 										   
							   	</div>
							</div>							
							<div class="form-group">
				...
				<div class="row">			
					<form role="form" method="post" name="faculty_registration_form" action="<?php echo esc_url($_SERVER['PHP_SELF']); ?>">
						<div class="col-lg-6 col-sm-6 col-sm-push-2 col-lg-push-1 ">
							<br>
							<div class="well well-sm"><strong>به روز رسانی اطلاعات شرکت کننده/استاد</strong></div>
							<div class="form-group">
							...
							<div class="form-group">
								...
								<div class="input-group">
									...
									<!--div id="FacultySelector" onmouseleave="showSelelctFaculty()" onload="showSelelctFaculty()" -->
							...
							<div class="form-group">
								<div class="input-group">
									...
									<input type="button" class="btn btn-info pull-right"
										   value="بازیابی اطلاعات" 
										   onclick="InformationSelectFaculty();" /> 										   
							   	</div>
							</div>									
